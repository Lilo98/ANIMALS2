...
$(document).ready(function(e) {
$('#AniPantalla').height($('#page3').height()); //Calcular el alto de la pantalla del dispositivo
		document.addEventListener("deviceready",function(){
		//precarga el sonido
		audio=window.plugins.LowLatencyAudio;  //Crear una carpta audio que contenga los sonidos de las notas en formato mp3
		audio.preloadFX('aguila','audio/aguila.mp3', function(){}, function (e){alert('Error  ' +e);}); 
		audio.preloadFX('cascael','audio/cascabel.mp3', function(){}, function (e){alert('Error  ' +e);});
